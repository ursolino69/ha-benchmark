...
for item in "$APP_SOURCE/service.py" "$APP_SOURCE/static/index.html" "$BENCH_SOURCE/sharing.py" "$BENCH_SOURCE/scoring_r4.py" "$BENCH_SOURCE/device_types.py"; do
...
install -m 0644 "$APP_SOURCE/service.py" "$BENCH_SOURCE/sharing.py" "$BENCH_SOURCE/scoring_r4.py" "$BENCH_SOURCE/device_types.py" "$INSTALL_DIR/app/"
rm -f "$INSTALL_DIR/app/scoring_r3.py"
